param(
  ...
  [string]$CandidateMetricsCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_public_vs_hgb_meta_margin004_writepred_20260709\gate_public_vs_hgb_meta_margin004_lead12\basin_lead_metrics.csv",
  [string]$CandidateManifestJson = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_public_vs_hgb_meta_margin004_writepred_20260709\gate_public_vs_hgb_meta_margin004_lead12\manifest.json",
  [string]$CandidateSkillClassesCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_public_vs_hgb_meta_margin004_lead12_basin_skill_classes_20260709.csv",
  [string]$CandidateLabel = "Strict obs HGB residual gate margin 0.04 lead1-2",
