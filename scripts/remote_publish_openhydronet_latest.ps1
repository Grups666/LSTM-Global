param(
  ...
  [string]$CandidateMetricsCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_current_hgb045_basinraw_old_hgbprobe_balanced_20260709\gate_current_hgb045_basinraw_old_hgbprobe_balanced_lead12\basin_lead_metrics.csv",
  [string]$CandidateManifestJson = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_current_hgb045_basinraw_old_hgbprobe_balanced_20260709\gate_current_hgb045_basinraw_old_hgbprobe_balanced_lead12\manifest.json",
  [string]$CandidateSkillClassesCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_current_hgb045_basinraw_old_hgbprobe_balanced_lead12_basin_skill_classes_20260709.csv",
  [string]$CandidateLabel = "Strict obs balanced five-member validation gate lead1-2",
