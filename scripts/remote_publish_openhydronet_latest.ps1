param(
  ...
  [string]$CandidateMetricsCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_current_raw100_dominating_writepred_20260710\gate_current_raw100_cminm05_fmaxm01_lead12\basin_lead_metrics.csv",
  [string]$CandidateManifestJson = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_current_raw100_dominating_writepred_20260710\gate_current_raw100_cminm05_fmaxm01_lead12\manifest.json",
  [string]$CandidateSkillClassesCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_current_raw100_dominating_writepred_20260710\gate_current_raw100_cminm05_fmaxm01_lead12_basin_skill_classes.csv",
  [string]$CandidateLabel = "Strict obs raw-scale rescue validation gate lead1-2",
