param(
  ...
  [string]$CandidateMetricsCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_multi_online_m0_cmin1_fmax0_writepred_20260710\gate_multi_online_m0_cmin1_fmax0_lead12\basin_lead_metrics.csv",
  [string]$CandidateManifestJson = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_multi_online_m0_cmin1_fmax0_writepred_20260710\gate_multi_online_m0_cmin1_fmax0_lead12\manifest.json",
  [string]$CandidateSkillClassesCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_multi_online_m0_cmin1_fmax0_writepred_20260710\gate_multi_online_m0_cmin1_fmax0_lead12_basin_skill_classes.csv",
  [string]$CandidateLabel = "Strict obs multi-candidate validation gate lead1-2",
