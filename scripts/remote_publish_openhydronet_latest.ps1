param(
  ...
  [string]$CandidateMetricsCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_metric_broad_m0_c02_f03_writepred_20260710\gate_metric_broad_m0_c02_f03_lead12\basin_lead_metrics.csv",
  [string]$CandidateManifestJson = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_metric_broad_m0_c02_f03_writepred_20260710\gate_metric_broad_m0_c02_f03_lead12\manifest.json",
  [string]$CandidateSkillClassesCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_metric_broad_m0_c02_f03_writepred_20260710\gate_metric_broad_m0_c02_f03_lead12_basin_skill_classes.csv",
  [string]$CandidateLabel = "Strict obs broad metric-table validation gate lead1-2",
