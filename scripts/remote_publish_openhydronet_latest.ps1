param(
  ...
  [string]$CandidateMetricsCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_blendaware_margin005_meanfallback_20260709\gate_blendaware_margin005_meanfallback_lead12\basin_lead_metrics.csv",
  [string]$CandidateManifestJson = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_blendaware_margin005_meanfallback_20260709\gate_blendaware_margin005_meanfallback_lead12\manifest.json",
  [string]$CandidateSkillClassesCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_blendaware_margin005_meanfallback_lead12_basin_skill_classes_20260709.csv",
  [string]$CandidateLabel = "Strict obs posttrain blend-aware margin gate lead1-2",
