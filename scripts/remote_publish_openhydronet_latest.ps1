param(
  ...
  [string]$CandidateMetricsCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_orig_vs_global_rawscale_marginnone_writepred_20260709\gate_orig_vs_global_rawscale_marginnone_lead12\basin_lead_metrics.csv",
  [string]$CandidateManifestJson = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_orig_vs_global_rawscale_marginnone_writepred_20260709\gate_orig_vs_global_rawscale_marginnone_lead12\manifest.json",
  [string]$CandidateSkillClassesCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_orig_vs_global_rawscale_marginnone_lead12_basin_skill_classes_20260709.csv",
  [string]$CandidateLabel = "Strict obs gate with validation global raw-scale lead1-2",
