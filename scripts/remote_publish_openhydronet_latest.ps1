param(
  ...
  [string]$CandidateMetricsCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_margin005_meanfallback_fulltrain_pilot_weighted_mean_20260709\gate_margin005_meanfallback_lead12_fulltrain_pilot_weighted_mean\basin_lead_metrics.csv",
  [string]$CandidateManifestJson = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_margin005_meanfallback_fulltrain_pilot_weighted_mean_20260709\gate_margin005_meanfallback_lead12_fulltrain_pilot_weighted_mean\manifest.json",
  [string]$CandidateSkillClassesCsv = "D:\SSH\Hydrological_Forecasting_DL\local\outputs\strict_obs_posttrain\gate_margin005_meanfallback_lead12_basin_skill_classes_20260709.csv",
  [string]$CandidateLabel = "Strict obs posttrain margin gate lead1-2",
