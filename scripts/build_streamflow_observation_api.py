...
def load_candidate_metrics(
    ...
    *,
    ...
    summary = {
        ...
        "gate": manifest.get("gate") or manifest.get("selector") or manifest.get("protector"),
        "selector": manifest.get("selector"),
        "protector": manifest.get("protector"),
        "calibrationSplit": manifest.get("calibration_split"),
        "calibrationHoldoutCutoffIssueDate": manifest.get("calibration_holdout_cutoff_issue_date"),
...
def main() -> None:
    ...
    latest_payload = {
        ...
        "evaluatedRecentBasins": candidate_summary.get("basinCount") if candidate_summary else None,
